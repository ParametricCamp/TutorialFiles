...
{
    public class AsyncForLoopSpeckleComponent : GH_AsyncComponent
    {
        /// <summary>
        /// Initializes a new instance of the AsyncForLoop class.
        /// </summary>
        public AsyncForLoopSpeckleComponent()
          : base("AsyncForLoop (Speckle)", "AsyncForLoop (Speckle)",
              "AsyncForLoop using the Speckle template.",
              "PCamp", "Async")
        {
