...
{
    public class SubtractionComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the AddNumbersComponent class.
        /// </summary>
        public SubtractionComponent()
          : base("Subtraction", "Subtraction",
              "",
              "PCamp", "Utilities")
        {
        }
        ...
        {
            get { return new Guid("BB011A8B-1BF6-4B5A-8F32-86C1EF03AA18"); }
        }
    }
}