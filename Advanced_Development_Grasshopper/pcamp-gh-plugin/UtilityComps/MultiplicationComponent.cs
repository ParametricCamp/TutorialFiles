...
{
    public class MultiplicationComponent : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the AddNumbersComponent class.
        /// </summary>
        public MultiplicationComponent()
          : base("Multiplication", "Multiplication",
              "",
              "PCamp", "Utilities")
        {
        }
        ...
        {
            get { return new Guid("464314BF-4D5B-4996-B25D-018F46491A67"); }
        }
    }
}